...
{
    public class SachHayBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public SachHayBlogContext(DbContextOptions options) : base(options)
        {
        }
        ...
        public override Task<int> SaveChangesAsync(bool acceptAllChangesOnSuccess, CancellationToken cancellationToken = default)
        {
            ...
            foreach(var entityEntry in entries)
            {
                ...
                var modifiedProp = entityEntry.Entity.GetType().GetProperty("ModifiedDate");
                if (entityEntry.State == EntityState.Modified && modifiedProp != null)
                {
