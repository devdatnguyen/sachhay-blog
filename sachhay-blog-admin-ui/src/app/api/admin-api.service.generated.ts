...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getPostPaging(keyword?: string | null | undefined, categoryId?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<PostInListDtoPageResult> {
    ...
    protected processGetPostPaging(response: HttpResponseBase): Observable<PostInListDtoPageResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PostInListDtoPageResult implements IPostInListDtoPageResult {
    ...
    rowCount?: number;
    pageCount?: number;
    readonly fristRowOnPage?: number;
    readonly lastRowOnPage?: number;
    addionalData?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).fristRowOnPage = _data["fristRowOnPage"];
            (<any>this).lastRowOnPage = _data["lastRowOnPage"];
            this.addionalData = _data["addionalData"];
    ...
    toJSON(data?: any) {
        ...
        data["fristRowOnPage"] = this.fristRowOnPage;
        data["lastRowOnPage"] = this.lastRowOnPage;
        data["addionalData"] = this.addionalData;
